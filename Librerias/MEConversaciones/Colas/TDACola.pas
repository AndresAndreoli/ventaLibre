...
uses
  TiposYconstantes, TDAColasParciales;
    ...
    TipoCola = TDAColasParciales.TipoCola;
  ...
  function  Buscar        (var Me:TipoCola; Clave:TipoPosicion; Cliente: TipoPosicion; var posEnc: TipoPosicion):boolean;
...
//------------------------------------------------------------------------------CrearCola
	Procedure CrearCola(var cola:TipoCola; ruta,nombre:String);
  begin
    TDAColasParciales.CrearCola(cola, ruta, nombre);
  end;
//------------------------------------------------------------------------------AbrirCola
	Procedure AbrirCola(var Cola:TipoCola);
		begin
  ...
  begin
   ...
   while not corte do
    begin
      ...
      Decolar(me);
      if reg.Clave <> -1 then 
      if (clave = reg.clave) and (reg.idCliente=cliente) then
