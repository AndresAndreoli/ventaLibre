...
uses
  TiposYconstantes, Dialogs, SysUtils;
	...
	const
		//_NombreControl = 'control.CON';
		//_NombreDatos = 'datos.DAT';
		_PosNula = TiposYconstantes._PosNula;
	 //_PrimerElemento = 0;
		//_ClaveNula = '';

	type
		TipoColor = String[6];//PermiteSoloStringDe6Caracteres
		TipoPosicion = Longint;

		registroDatos = record
                      clave:            TiposYconstantes.tipoPosicion;
                      mensajeComprador: TiposYconstantes.tipoMensaje;
                      mensajeVendedor:  TiposYconstantes.tipoMensaje;
                      fecha:            TiposYconstantes.tipoFecha;
    ...
    registroIndice = record
                        clave:            TiposYconstantes.tipoPosicion; // IDPublicacion
                        idCliente:        TiposYconstantes.tipoPosicion;
                        ultimoNumero:     TiposYconstantes.tipoPosicion;
                        primero, ultimo:  TiposYconstantes.tipoPosicion;
                        siguiente:        TiposYconstantes.tipoPosicion;
                      end;
...
//------------------------------------------------------------------------------Encolar
	Procedure Encolar(var Cola:TipoCola; Reg: registroDatos; var regInd: registroIndice; posIndice: tipoposicion);
      ...
      //showmessage('posInd '+inttostr(posIndice));
